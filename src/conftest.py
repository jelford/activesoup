...
def add_html_parsing(doctest_namespace):
    ...
    def html_page(raw_html):
        ...
        return activesoup.html.resolve(
            driver=None, response=response_from_server
        )  # typing: ignore
...
def fake_github(requests_mock):
    for form in (
        "https://github.com/jelford/activesoup/",
        "https://github.com/jelford/activesoup",
    ):
        requests_mock.get(
            form,
    ...
    requests_mock.get(
        "https://github.com/jelford/activesoup/issues/new",
    ...
    requests_mock.get(
        "https://github.com/jelford/activesoup/issues/1", text="Dummy page"
    )
